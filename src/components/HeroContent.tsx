  ...
  return (
    <motion.div className="max-w-xl" variants={container} initial="hidden" animate="show">
      ...
      <motion.h1
        ...
        style={{ fontSize: 'clamp(60px, 8vw, 84px)' }}
      >
      ...
      <motion.p
        variants={item}
        className="text-[rgba(255,255,255,0.58)] text-[15px] leading-relaxed max-w-md mt-6"
      >
      ...
      <motion.div variants={item} className="mt-8 flex items-center gap-3">
        ...
        <Link
          href="/news"
          className="px-5 py-2.5 rounded-lg text-sm font-bold text-bright border border-white/20 hover:border-white/40 transition-colors"
        >
          Latest Rumors
        </Link>
      </motion.div>
